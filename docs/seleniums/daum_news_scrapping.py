    ...
    for k in range(len(btn_month_list)):
        ...
        while True:
            ...
            for news_element in news_list:
                news_brand = news_element.find_element(by=By.CSS_SELECTOR,value="div.c-tit-doc > div.area_tit > div > a > strong > span")
                news_title = news_element.find_element(by=By.CSS_SELECTOR,value="div.c-item-content > div.item-bundle-mid > div.item-title > strong > a")
                news_date = news_element.find_element(by=By.CSS_SELECTOR,value="div.c-item-content > div.item-bundle-mid > div.item-contents > span > span")
                print(news_brand.text)
                print(news_title.text)
                print(news_date.text)
                collection.insert_one({'title': news_title.text,
                               'date':news_date.text,
